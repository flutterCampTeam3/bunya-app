...
class PostOfficeHomeWidget extends StatelessWidget {
  const PostOfficeHomeWidget(
      {super.key,
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => HomeOfficesBloc()
        ..add(ShowDataOfficesEvent())
        ..add(CheckLikeHomeOfficesEvent(id: description.postId)),
      child: Builder(
        builder: (context) {
