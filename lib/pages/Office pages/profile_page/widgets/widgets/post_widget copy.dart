  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Builder(builder: (context) {
        ...
        bloc.add(GetLikeNumberOfficeEvent(id: desc.postId));
        bloc.add(CheckLikeOfficeEvent(id: desc.postId));
                  ...
                  children: [
                    ...
                    Positioned(
                        ...
                        child: bloc.isLike
                            ? InkWell(
                                onTap: () {
                                  bloc.add(DeleteLikeOfficeEvent(id: desc.postId));
                                },
                                child: const Icon(
                                  Icons.favorite,
                                  color: Colors.red,
                            ...
                            : InkWell(
                                onTap: () {
                                  bloc.add(AddLikeOfficeEvent(post: desc));
                                },
                                child:
