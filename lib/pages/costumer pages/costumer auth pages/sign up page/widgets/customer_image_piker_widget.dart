...
class CustomerImagePickerWidget extends StatelessWidget {
              ...
              child: Container(
                ...
                child: BlocBuilder<SignUpBlocCustomer, SignUpCustomerState>(
                  builder: (context, state) {
                    if (state is CustomerChoosImageEventShowImageState) {
                      return CircleAvatar(
                          radius: 70,
                          backgroundImage:
                    ...
                    return CircleAvatar(
                      ...
                      child: IconButton(
                        onPressed: () {
                          BlocProvider.of<SignUpBlocCustomer>(context)
                              .add(CustomerChoosImageEvent());
                        },
